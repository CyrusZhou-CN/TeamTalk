...
class IMP2PCmdMsg final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR IMP2PCmdMsg(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
void IMP2PCmdMsg::set_cmd_msg_data(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.cmd_msg_data_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline const std::string& IMP2PCmdMsg::_internal_cmd_msg_data() const {
  return _impl_.cmd_msg_data_.Get();
}
inline void IMP2PCmdMsg::_internal_set_cmd_msg_data(const std::string& value) {
  
  _impl_.cmd_msg_data_.Set(value, GetArenaForAllocation());
}
inline std::string* IMP2PCmdMsg::_internal_mutable_cmd_msg_data() {
  
  return _impl_.cmd_msg_data_.Mutable(GetArenaForAllocation());
}
inline std::string* IMP2PCmdMsg::release_cmd_msg_data() {
  ...
  return _impl_.cmd_msg_data_.Release();
}
inline void IMP2PCmdMsg::set_allocated_cmd_msg_data(std::string* cmd_msg_data) {
  ...
  _impl_.cmd_msg_data_.SetAllocated(cmd_msg_data, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.cmd_msg_data_.IsDefault()) {
