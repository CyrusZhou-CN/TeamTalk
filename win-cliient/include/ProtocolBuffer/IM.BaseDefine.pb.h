...
enum InternalCmdID : int {
  ...
  InternalCmdID_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  InternalCmdID_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
...
enum BuddyListCmdID : int {
  ...
  BuddyListCmdID_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  BuddyListCmdID_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
...
enum GroupCmdID : int {
  ...
  GroupCmdID_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  GroupCmdID_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
...
enum FileCmdID : int {
  ...
  FileCmdID_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  FileCmdID_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
...
enum SwitchServiceCmdID : int {
  ...
  SwitchServiceCmdID_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  SwitchServiceCmdID_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
...
enum OtherCmdID : int {
  ...
  OtherCmdID_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  OtherCmdID_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
...
enum KickReasonType : int {
  ...
  KickReasonType_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  KickReasonType_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
...
enum OnlineListType : int {
  ...
  OnlineListType_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  OnlineListType_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
...
enum GroupType : int {
  ...
  GROUP_TYPE_NORMAL = 1,
  GROUP_TYPE_TMP = 2,
  GroupType_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  GroupType_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
...
enum GroupModifyType : int {
  ...
  GroupModifyType_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  GroupModifyType_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
...
constexpr FileType FileType_MIN = FILE_TYPE_NONE;
...
enum ClientFileState : int {
  ...
  CLIENT_FILE_DONE = 3,
  ClientFileState_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  ClientFileState_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
...
enum ClientFileRole : int {
  ...
  ClientFileRole_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  ClientFileRole_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
...
enum FileServerError : int {
  ...
  FileServerError_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  FileServerError_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
...
enum SessionStatusType : int {
  ...
  SessionStatusType_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  SessionStatusType_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
...
enum DepartmentStatusType : int {
  ...
  DepartmentStatusType_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  DepartmentStatusType_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
...
class AuthInfo final :
 ...
 public:
  ...
  PROTOBUF_NODISCARD std::string* release_allowd_user_ids();
  ...
  PROTOBUF_NODISCARD std::string* release_allowd_group_ids();
  ...
  PROTOBUF_NODISCARD std::string* release_auth_interfaces();
  ...
  PROTOBUF_NODISCARD std::string* release_auth_ips();
...
inline std::string* UserInfo::release_user_nick_name() {
  ...
  return _impl_.user_nick_name_.Release();
}
...
inline std::string* UserInfo::release_user_real_name() {
  ...
  return _impl_.user_real_name_.Release();
}
...
inline std::string* UserInfo::release_user_tel() {
  ...
  return _impl_.user_tel_.Release();
}
...
inline std::string* UserInfo::release_user_domain() {
  ...
  return _impl_.user_domain_.Release();
}
...
inline ::IM::BaseDefine::SessionType ContactSessionInfo::_internal_session_type() const {
  return static_cast< ::IM::BaseDefine::SessionType >(_impl_.session_type_);
}
...
inline ::IM::BaseDefine::SessionStatusType ContactSessionInfo::_internal_session_status() const {
  return static_cast< ::IM::BaseDefine::SessionStatusType >(_impl_.session_status_);
}
...
inline std::string* ContactSessionInfo::release_latest_msg_data() {
  ...
  return _impl_.latest_msg_data_.Release();
}
...
inline void ContactSessionInfo::clear_latest_msg_type() {
  _impl_.latest_msg_type_ = 0;
}
inline ::IM::BaseDefine::MsgType ContactSessionInfo::_internal_latest_msg_type() const {
  return static_cast< ::IM::BaseDefine::MsgType >(_impl_.latest_msg_type_);
}
...
inline ::IM::BaseDefine::UserStatType UserStat::_internal_status() const {
  return static_cast< ::IM::BaseDefine::UserStatType >(_impl_.status_);
}
...
inline ::IM::BaseDefine::ClientType ServerUserStat::_internal_client_type() const {
  return static_cast< ::IM::BaseDefine::ClientType >(_impl_.client_type_);
}
...
inline ::IM::BaseDefine::MsgType MsgInfo::_internal_msg_type() const {
  return static_cast< ::IM::BaseDefine::MsgType >(_impl_.msg_type_);
}
...
inline ::IM::BaseDefine::GroupType GroupInfo::_internal_group_type() const {
  return static_cast< ::IM::BaseDefine::GroupType >(_impl_.group_type_);
}
...
inline ::IM::BaseDefine::ClientType UserTokenInfo::_internal_user_type() const {
  return static_cast< ::IM::BaseDefine::ClientType >(_impl_.user_type_);
}
...
inline uint32_t AuthInfo::_internal_user_id() const {
  return _impl_.user_id_;
}
inline uint32_t AuthInfo::user_id() const {
  // @@protoc_insertion_point(field_get:IM.BaseDefine.AuthInfo.user_id)
  return _internal_user_id();
}
inline void AuthInfo::_internal_set_user_id(uint32_t value) {
  
  _impl_.user_id_ = value;
}
inline void AuthInfo::set_user_id(uint32_t value) {
  _internal_set_user_id(value);
...
void AuthInfo::set_allowd_user_ids(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.allowd_user_ids_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline const std::string& AuthInfo::_internal_allowd_user_ids() const {
  return _impl_.allowd_user_ids_.Get();
}
inline void AuthInfo::_internal_set_allowd_user_ids(const std::string& value) {
  
  _impl_.allowd_user_ids_.Set(value, GetArenaForAllocation());
}
inline std::string* AuthInfo::_internal_mutable_allowd_user_ids() {
  
  return _impl_.allowd_user_ids_.Mutable(GetArenaForAllocation());
}
inline std::string* AuthInfo::release_allowd_user_ids() {
  ...
  return _impl_.allowd_user_ids_.Release();
}
inline void AuthInfo::set_allocated_allowd_user_ids(std::string* allowd_user_ids) {
  ...
  _impl_.allowd_user_ids_.SetAllocated(allowd_user_ids, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.allowd_user_ids_.IsDefault()) {
...
void AuthInfo::set_allowd_group_ids(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.allowd_group_ids_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline const std::string& AuthInfo::_internal_allowd_group_ids() const {
  return _impl_.allowd_group_ids_.Get();
}
inline void AuthInfo::_internal_set_allowd_group_ids(const std::string& value) {
  
  _impl_.allowd_group_ids_.Set(value, GetArenaForAllocation());
}
inline std::string* AuthInfo::_internal_mutable_allowd_group_ids() {
  
  return _impl_.allowd_group_ids_.Mutable(GetArenaForAllocation());
}
inline std::string* AuthInfo::release_allowd_group_ids() {
  ...
  return _impl_.allowd_group_ids_.Release();
}
inline void AuthInfo::set_allocated_allowd_group_ids(std::string* allowd_group_ids) {
  ...
  _impl_.allowd_group_ids_.SetAllocated(allowd_group_ids, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.allowd_group_ids_.IsDefault()) {
...
void AuthInfo::set_auth_interfaces(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.auth_interfaces_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline const std::string& AuthInfo::_internal_auth_interfaces() const {
  return _impl_.auth_interfaces_.Get();
}
inline void AuthInfo::_internal_set_auth_interfaces(const std::string& value) {
  
  _impl_.auth_interfaces_.Set(value, GetArenaForAllocation());
}
inline std::string* AuthInfo::_internal_mutable_auth_interfaces() {
  
  return _impl_.auth_interfaces_.Mutable(GetArenaForAllocation());
}
inline std::string* AuthInfo::release_auth_interfaces() {
  ...
  return _impl_.auth_interfaces_.Release();
}
inline void AuthInfo::set_allocated_auth_interfaces(std::string* auth_interfaces) {
  ...
  _impl_.auth_interfaces_.SetAllocated(auth_interfaces, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.auth_interfaces_.IsDefault()) {
...
void AuthInfo::set_auth_ips(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.auth_ips_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void AuthInfo::set_allocated_auth_ips(std::string* auth_ips) {
  ...
  _impl_.auth_ips_.SetAllocated(auth_ips, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.auth_ips_.IsDefault()) {
...
inline std::string* DepartInfo::release_dept_name() {
  ...
  return _impl_.dept_name_.Release();
}
...
inline ::IM::BaseDefine::DepartmentStatusType DepartInfo::_internal_dept_status() const {
  return static_cast< ::IM::BaseDefine::DepartmentStatusType >(_impl_.dept_status_);
}
